...
mkdir -p manual
unoconv --doctype=spreadsheet --format=csv --stdout source/cv-lineage.ods > manual/cv-lineage.csv
justify.sh                                          source/cv-lineage.ods   manual/cv-lineage.csv unoconv

cr-create-conversion-trigger.sh -w manual/cv-lineage.csv
